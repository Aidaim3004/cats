...
const FavoriteBtn = ({onClick, isFavorites = false}) => {
  return (
      <svg onClick={onClick} className="favorite-svg" width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M19.5 34C4 19 2 12.5 2 9.5C2.71082 5.59047 4.92166 3.49676 4.3535 3.4293L4 3.5C4.16721 3.44426 4.28223 3.42084 4.3535 3.4293L11.5 2L19.5 6.5L27 2H33.5L38 9.5L35.5 18.5L29 25.5L19.5 34Z" fill={isFavorites ? 'red' :  'transparent'} />
      </svg>
